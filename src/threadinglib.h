 ...
 * your system memory or some other resource, you have to divide tasks into sessions.
 * AbstractSessionManager is an abstract class, which has to be derived and its
 * methods sessionCount() and initNextSession() should be implemented. Method
